...
A Worms-style artillery game built for **Ritual** — 2 teams (1 vs 1, 2 vs 2, or 3 vs 3), 4 weapons, destructible terrain, Vs CPU or 2-player hotseat, EVM wallet connection (MetaMask, OKX, Rabby, Bitget, Coinbase Wallet, ...) to the **Ritual Chain testnet**, and on-chain win recording.
